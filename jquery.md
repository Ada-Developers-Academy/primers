...
Ok. So. JavaScript. It does magical things in web browsers by dynamically altering the content of web pages based on user activity. Here's what it looks like:
